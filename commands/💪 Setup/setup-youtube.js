                ...
                try {
                    ...
                    async function first_layer() {
                        ...
                        let MenuEmbed = new MessageEmbed()
                            .setColor(es.color)
                            .setAuthor('Youtube-Poster', 'https://www.youtube.com/channel/UChWC-G-6LEwj_ldW1288Z4g', 'https://discord.gg/aCbEXCytq6')
      ...
      async function handle_the_picks(optionhandletype, SetupNumber, menuoptiondata) {
        switch (optionhandletype) {
          ...
          var tempmsg = await message.reply({embeds: [new Discord.MessageEmbed()
            ...
            .setColor(es.color)
            .setDescription(`Example:\nhttps://www.youtube.com/channel/UChWC-G-6LEwj_ldW1288Z4g`)
            .setFooter(client.getFooter(es))]
          })
          await tempmsg.channel.awaitMessages({filter: m => m.author.id === message.author.id,
              max: 1,
          ...
          case "Remove Youtube Channel":{
            ...
            let MenuEmbed = new MessageEmbed()
              .setColor(es.color)
              .setAuthor('Youtube-Poster', 'https://cdn.discordapp.com/emojis/840260133686870036.png?size=128', 'https://discord.gg/aCbEXCytq6')
