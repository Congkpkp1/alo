...
module.exports = {
        ...
        let button_tutorial = new MessageButton().setStyle('LINK').setEmoji("840260133686870036").setLabel("Tutorial").setURL("https://www.youtube.com/watch?v=nOwNF5oo-Hc")
        let menuOptions = [
          {
            label: "Overview",
            value: "Overview",
        ...
        let OverviewEmbed = new MessageEmbed()
          ...
          .addField(":muscle: **__My Features__**",
            `>>> **58+ Systems**, **Twitter-**  **Youtube-Auto-Poster** 
**Application-**, **Ticket-**, **Welcome-Images-** and **Reaction Role-**, ... Systems
:notes: An advanced <**Spotify**> **Music System** with **Audio Filtering**
...
📶 **\`${Math.floor(client.ws.ping)}ms\` Ping**
  Made by [**DeRux Development**](https://discord.gg/aCbEXCytq6)`)
